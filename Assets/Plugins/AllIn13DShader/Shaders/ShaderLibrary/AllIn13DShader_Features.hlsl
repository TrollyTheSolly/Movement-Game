...
//------------------------
	...
	DECLARE_PROPERTY_FLOAT(_TimingSeed)
	...
	#if defined(_TEXTURE_BLENDING_ON) || defined(URP_PASS)
		#if defined(_TEXTUREBLENDINGMODE_RGB) || defined(URP_PASS)
			DECLARE_PROPERTY_FLOAT4(_BlendingTextureG_ST)
			DECLARE_PROPERTY_FLOAT4(_BlendingTextureB_ST)
		#elif defined(_TEXTUREBLENDINGMODE_BLACKANDWHITE) || defined(URP_PASS)
			DECLARE_PROPERTY_FLOAT4(_BlendingTextureWhite_ST)
		#endif

		#if defined(_TEXTUREBLENDINGSOURCE_TEXTURE) || defined(URP_PASS)
		...
		#if defined(_TEXTUREBLENDINGMODE_BLACKANDWHITE) || defined(URP_PASS)		
